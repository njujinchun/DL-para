...
### Three original log-permeability field realizations (a-c), histograms of DL model-encoded latent variables (d-f), the DL model reconstructed log-permeability field realizations (g-i) and three random log-permeability field realizations generated by the DL model’s decoder given inputs drawn from the standard normal distribution (j-l)
